...
java.classpath.push(__dirname + "/aspose-slides-23.8-nodejs.jar");
...
exports.AudioCollection.addAudioFromStream = function(arg0, arg1, arg2) {
if (arguments.length == 3 && __typeof__(arg0) == "ReadStream" && __typeof__(arg2) == "Function") {
	...
	arg0.on('end', function() {
		...
		var error;
		try {
			item = exports.AudioCollection.addAudio(inputStreamBuffer.toInputStream(), arg1);
		}
		catch (err) {
			error = err;
		}
	...
	arg0.on('end', function() {
		...
		var error;
		try {
			item = exports.AudioCollection.addAudio(inputStreamBuffer.toInputStream());
		}
		catch (err) {
			error = err;
		}
...
exports.CustomXmlPartCollection.addFromStream = function(arg0, arg1) {
if (arguments.length == 2 && __typeof__(arg0) == "ReadStream" && __typeof__(arg1) == "Function") {
	...
	arg0.on('end', function() {
		...
		var error;
		try {
			item = exports.CustomXmlPartCollection.add(inputStreamBuffer.toInputStream());
		}
		catch (err) {
			error = err;
		}
...
exports.ForEach_ = java.import("com.aspose.slides.ForEach_");
...
exports.ImageCollection.addImageFromStream = function(arg0, arg1, arg2) {
if (arguments.length == 3 && __typeof__(arg0) == "ReadStream" && __typeof__(arg2) == "Function") {
	var inputStreamBuffer = new exports.StreamBuffer();
	arg0.on('data', function(chunk) {
		inputStreamBuffer.write(chunk);
	...
	arg0.on('end', function() {
		...
		var error;
		try {
			item = exports.ImageCollection.addImage(inputStreamBuffer.toInputStream(), arg1);
		}
		catch (err) {
			error = err;
		}
	...
	arg0.on('end', function() {
		...
		var error;
		try {
			item = exports.ImageCollection.addImage(inputStreamBuffer.toInputStream());
		}
		catch (err) {
			error = err;
		}
...
exports.License.setLicenseFromStream = function(arg0, arg1) {
if (arguments.length == 2 && __typeof__(arg0) == "ReadStream" && __typeof__(arg1) == "Function") {
	var inputStreamBuffer = new exports.StreamBuffer();
	arg0.on('data', function(chunk) {
		inputStreamBuffer.write(chunk);
	...
	arg0.on('end', function() {
		...
		var error;
		try {
			item = exports.License.setLicense(inputStreamBuffer.toInputStream());
		}
		catch (err) {
			error = err;
		}
...
exports.MathBlock.writeAsMathMlToStream = function(arg0) {
if (arguments.length == 1 && __typeof__(arg0) == "WriteStream") {
	var outputStreamBuffer = new exports.StreamBuffer();
	exports.MathBlock.writeAsMathMl(outputStreamBuffer);
	var buf;
...
exports.MathParagraph.writeAsMathMlToStream = function(arg0) {
if (arguments.length == 1 && __typeof__(arg0) == "WriteStream") {
	var outputStreamBuffer = new exports.StreamBuffer();
	exports.MathParagraph.writeAsMathMl(outputStreamBuffer);
	var buf;
	while ((buf = outputStreamBuffer.read(4096)) != null) {
		arg0.write(new Buffer(buf));
	}
...
exports.OutputFile.writeToStream = function(arg0) {
if (arguments.length == 1 && __typeof__(arg0) == "WriteStream") {
	var outputStreamBuffer = new exports.StreamBuffer();
	exports.OutputFile.write(outputStreamBuffer);
	var buf;
	while ((buf = outputStreamBuffer.read(4096)) != null) {
		arg0.write(new Buffer(buf));
	}
...
exports.Presentation.saveToStream = function(arg0, arg1, arg2, arg3) {
if (arguments.length == 4 && __typeof__(arg0) == "WriteStream") {
	var outputStreamBuffer = new exports.StreamBuffer();
	exports.Presentation.save(outputStreamBuffer, arg1, arg2, arg3);
	var buf;
	while ((buf = outputStreamBuffer.read(4096)) != null) {
		arg0.write(new Buffer(buf));
	}
	...
	var outputStreamBuffer = new exports.StreamBuffer();
	exports.Presentation.save(outputStreamBuffer, arg1, arg2);
	var buf;
	while ((buf = outputStreamBuffer.read(4096)) != null) {
		arg0.write(new Buffer(buf));
	}
	...
	var outputStreamBuffer = new exports.StreamBuffer();
	exports.Presentation.save(outputStreamBuffer, arg1);
	var buf;
	while ((buf = outputStreamBuffer.read(4096)) != null) {
		arg0.write(new Buffer(buf));
	}
...
exports.PresentationFactory.getPresentationInfoFromStream = function(arg0, arg1) {
if (arguments.length == 2 && __typeof__(arg0) == "ReadStream" && __typeof__(arg1) == "Function") {
	var inputStreamBuffer = new exports.StreamBuffer();
	arg0.on('data', function(chunk) {
		inputStreamBuffer.write(chunk);
	...
	arg0.on('end', function() {
		...
		var error;
		try {
			item = exports.PresentationFactory.getPresentationInfo(inputStreamBuffer.toInputStream());
		}
		catch (err) {
			error = err;
		}
...
exports.PresentationFactory.readPresentationFromStream = function(arg0, arg1, arg2) {
if (arguments.length == 3 && __typeof__(arg0) == "ReadStream" && __typeof__(arg2) == "Function") {
	var inputStreamBuffer = new exports.StreamBuffer();
	arg0.on('data', function(chunk) {
		inputStreamBuffer.write(chunk);
	...
	arg0.on('end', function() {
		...
		var error;
		try {
			item = exports.PresentationFactory.readPresentation(inputStreamBuffer.toInputStream(), arg1);
		}
		catch (err) {
			error = err;
		}
	...
	arg0.on('end', function() {
		...
		var error;
		try {
			item = exports.PresentationFactory.readPresentation(inputStreamBuffer.toInputStream());
		}
		catch (err) {
			error = err;
		}
...
exports.PresentationFactory.getPresentationTextFromStream = function(arg0, arg1, arg2, arg3) {
if (arguments.length == 4 && __typeof__(arg0) == "ReadStream" && __typeof__(arg3) == "Function") {
	...
	arg0.on('end', function() {
		...
		var error;
		try {
			item = exports.PresentationFactory.getPresentationText(inputStreamBuffer.toInputStream(), arg1, arg2);
		}
		catch (err) {
			error = err;
		}
...
else if (arguments.length == 3 && __typeof__(arg0) == "ReadStream" && __typeof__(arg2) == "Function") {
	var inputStreamBuffer = new exports.StreamBuffer();
	arg0.on('data', function(chunk) {
		inputStreamBuffer.write(chunk);
	});
	arg0.on('end', function() {
		...
		var error;
		try {
			item = exports.PresentationFactory.getPresentationText(inputStreamBuffer.toInputStream(), arg1);
		}
		catch (err) {
			error = err;
		}
...
exports.PresentationInfo.writeBindedPresentationToStream = function(arg0) {
if (arguments.length == 1 && __typeof__(arg0) == "WriteStream") {
	var outputStreamBuffer = new exports.StreamBuffer();
	exports.PresentationInfo.writeBindedPresentation(outputStreamBuffer);
	var buf;
	while ((buf = outputStreamBuffer.read(4096)) != null) {
		arg0.write(new Buffer(buf));
	}
...
exports.Shape.writeAsSvgToStream = function(arg0, arg1) {
if (arguments.length == 2 && __typeof__(arg0) == "WriteStream") {
	var outputStreamBuffer = new exports.StreamBuffer();
	exports.Shape.writeAsSvg(outputStreamBuffer, arg1);
	var buf;
	while ((buf = outputStreamBuffer.read(4096)) != null) {
		arg0.write(new Buffer(buf));
	}
...
else if (arguments.length == 1 && __typeof__(arg0) == "WriteStream") {
	var outputStreamBuffer = new exports.StreamBuffer();
	exports.Shape.writeAsSvg(outputStreamBuffer);
	var buf;
	while ((buf = outputStreamBuffer.read(4096)) != null) {
		arg0.write(new Buffer(buf));
	}
...
exports.ShapeCollection.insertAudioFrameEmbeddedFromStream = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
if (arguments.length == 7 && __typeof__(arg5) == "ReadStream" && __typeof__(arg6) == "Function") {
	var inputStreamBuffer = new exports.StreamBuffer();
	...
	arg5.on('end', function() {
		...
		var error;
		try {
			item = exports.ShapeCollection.insertAudioFrameEmbedded(arg0, arg1, arg2, arg3, arg4, inputStreamBuffer.toInputStream());
		}
		catch (err) {
			error = err;
		}
...
exports.ShapeCollection.addAudioFrameEmbeddedFromStream = function(arg0, arg1, arg2, arg3, arg4, arg5) {
if (arguments.length == 6 && __typeof__(arg4) == "ReadStream" && __typeof__(arg5) == "Function") {
	var inputStreamBuffer = new exports.StreamBuffer();
	...
	arg4.on('end', function() {
		...
		var error;
		try {
			item = exports.ShapeCollection.addAudioFrameEmbedded(arg0, arg1, arg2, arg3, inputStreamBuffer.toInputStream());
		}
		catch (err) {
			error = err;
		}
...
exports.Slide.writeAsSvgToStream = function(arg0, arg1) {
if (arguments.length == 2 && __typeof__(arg0) == "WriteStream") {
	var outputStreamBuffer = new exports.StreamBuffer();
	exports.Slide.writeAsSvg(outputStreamBuffer, arg1);
	var buf;
	while ((buf = outputStreamBuffer.read(4096)) != null) {
		arg0.write(new Buffer(buf));
	}
	...
	var outputStreamBuffer = new exports.StreamBuffer();
	exports.Slide.writeAsSvg(outputStreamBuffer);
	var buf;
	while ((buf = outputStreamBuffer.read(4096)) != null) {
		arg0.write(new Buffer(buf));
	}
...
exports.SlideCollection.insertFromHtmlFromStream = function(arg0, arg1, arg2, arg3, arg4) {
if (arguments.length == 5 && __typeof__(arg1) == "ReadStream" && __typeof__(arg4) == "Function") {
	var inputStreamBuffer = new exports.StreamBuffer();
	...
	arg1.on('end', function() {
		...
		var error;
		try {
			item = exports.SlideCollection.insertFromHtml(arg0, inputStreamBuffer.toInputStream(), arg2, arg3);
		}
		catch (err) {
			error = err;
		}
...
else if (arguments.length == 3 && __typeof__(arg1) == "ReadStream" && __typeof__(arg2) == "Function") {
	var inputStreamBuffer = new exports.StreamBuffer();
	arg1.on('data', function(chunk) {
		inputStreamBuffer.write(chunk);
	});
	arg1.on('end', function() {
		...
		var error;
		try {
			item = exports.SlideCollection.insertFromHtml(arg0, inputStreamBuffer.toInputStream());
		}
		catch (err) {
			error = err;
		}
...
exports.SlideCollection.addFromPdfFromStream = function(arg0, arg1) {
if (arguments.length == 2 && __typeof__(arg0) == "ReadStream" && __typeof__(arg1) == "Function") {
	var inputStreamBuffer = new exports.StreamBuffer();
	arg0.on('data', function(chunk) {
		inputStreamBuffer.write(chunk);
	...
	arg0.on('end', function() {
		...
		var error;
		try {
			item = exports.SlideCollection.addFromPdf(inputStreamBuffer.toInputStream());
		}
		catch (err) {
			error = err;
		}
...
exports.SlideCollection.addFromHtmlFromStream = function(arg0, arg1, arg2, arg3) {
if (arguments.length == 4 && __typeof__(arg0) == "ReadStream" && __typeof__(arg3) == "Function") {
	var inputStreamBuffer = new exports.StreamBuffer();
	arg0.on('data', function(chunk) {
		inputStreamBuffer.write(chunk);
	...
	arg0.on('end', function() {
		...
		var error;
		try {
			item = exports.SlideCollection.addFromHtml(inputStreamBuffer.toInputStream(), arg1, arg2);
		}
		catch (err) {
			error = err;
		}
	...
	arg0.on('end', function() {
		...
		var error;
		try {
			item = exports.SlideCollection.addFromHtml(inputStreamBuffer.toInputStream());
		}
		catch (err) {
			error = err;
		}
...
exports.VideoCollection.addVideoFromStream = function(arg0, arg1, arg2) {
if (arguments.length == 3 && __typeof__(arg0) == "ReadStream" && __typeof__(arg2) == "Function") {
	var inputStreamBuffer = new exports.StreamBuffer();
	arg0.on('data', function(chunk) {
		inputStreamBuffer.write(chunk);
	...
	arg0.on('end', function() {
		...
		var error;
		try {
			item = exports.VideoCollection.addVideo(inputStreamBuffer.toInputStream(), arg1);
		}
		catch (err) {
			error = err;
		}
	...
	arg0.on('end', function() {
		...
		var error;
		try {
			item = exports.VideoCollection.addVideo(inputStreamBuffer.toInputStream());
		}
		catch (err) {
			error = err;
		}
