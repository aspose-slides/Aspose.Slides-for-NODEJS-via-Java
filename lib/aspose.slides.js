...
java.classpath.push(__dirname + "/aspose-slides-26.7-nodejs.jar");
...
exports.AsposeAIWebClient = java.import("com.aspose.slides.AsposeAIWebClient");
...
exports.BrightnessContrast = java.import("com.aspose.slides.BrightnessContrast");
...
exports.Captions = java.import("com.aspose.slides.Captions");
exports.CaptionsCollection = java.import("com.aspose.slides.CaptionsCollection");
exports.CaptionsCollection.addFromStream = function(captionscollection, arg0, arg1, arg2) {
if (arguments.length == 4 && __typeof__(arg1) == "ReadStream" && __typeof__(arg2) == "Function") {
	var inputStreamBuffer = new exports.StreamBuffer();
	...
	arg1.on('end', function() {
		...
		var error;
		try {
			item = captionscollection.add(arg0, inputStreamBuffer.toInputStream());
		}
		catch (err) {
			error = err;
		}
...
exports.CompressionLevel = java.import("com.aspose.slides.CompressionLevel");
...
exports.DrawingGuide = java.import("com.aspose.slides.DrawingGuide");
exports.DrawingGuidesCollection = java.import("com.aspose.slides.DrawingGuidesCollection");
...
exports.EmbeddingLevel = java.import("com.aspose.slides.EmbeddingLevel");
...
exports.ExcelDataCell = java.import("com.aspose.slides.ExcelDataCell");
exports.ExcelDataWorkbook = java.import("com.aspose.slides.ExcelDataWorkbook");
exports.ExcelDataWorkbook.createExcelDataWorkbookFromStream = function(arg0, arg1) {
if (arguments.length == 2 && __typeof__(arg0) == "ReadStream" && __typeof__(arg1) == "Function") {
	...
	arg0.on('end', function() {
		var exceldataworkbook;
		var error;
		try {
			exceldataworkbook = java.newInstanceSync("com.aspose.slides.ExcelDataWorkbook", inputStreamBuffer.toInputStream());
		}
		catch (err) {
			error = err;
		}
		arg1(error, exceldataworkbook);
	});
}
else throw new Error("Invalid arguments");
};
exports.ExcelWorkbookImporter = java.import("com.aspose.slides.ExcelWorkbookImporter");
exports.ExcelWorkbookImporter.addChartFromWorkbookFromStream = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7) {
if (arguments.length == 8 && __typeof__(arg3) == "ReadStream" && __typeof__(arg7) == "Function") {
	var inputStreamBuffer = new exports.StreamBuffer();
	arg3.on('data', function(chunk) {
		inputStreamBuffer.write(chunk);
	});
	arg3.on('end', function() {
		var item;
		var error;
		try {
			item = exports.ExcelWorkbookImporter.addChartFromWorkbook(arg0, arg1, arg2, inputStreamBuffer.toInputStream(), arg4, arg5, arg6);
		}
		catch (err) {
			error = err;
		}
...
exports.ExcelWorkbookImporter.addTableFromWorkbookFromStream = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
if (arguments.length == 7 && __typeof__(arg3) == "ReadStream" && __typeof__(arg6) == "Function") {
	var inputStreamBuffer = new exports.StreamBuffer();
	arg3.on('data', function(chunk) {
		inputStreamBuffer.write(chunk);
	});
	arg3.on('end', function() {
		...
		var error;
		try {
			item = exports.ExcelWorkbookImporter.addTableFromWorkbook(arg0, arg1, arg2, inputStreamBuffer.toInputStream(), arg4, arg5);
		}
		catch (err) {
			error = err;
		}
...
exports.FontStyleType = java.import("com.aspose.slides.FontStyleType");
...
exports.GradientStyle = java.import("com.aspose.slides.GradientStyle");
...
exports.HandleRepeatedSpaces = java.import("com.aspose.slides.HandleRepeatedSpaces");
...
exports.HeadingPair = java.import("com.aspose.slides.HeadingPair");
...
exports.InkActions = java.import("com.aspose.slides.InkActions");
exports.InkBrush = java.import("com.aspose.slides.InkBrush");
exports.InkEffectType = java.import("com.aspose.slides.InkEffectType");
...
exports.LayoutPlaceholderManager = java.import("com.aspose.slides.LayoutPlaceholderManager");
...
exports.MathPhantom = java.import("com.aspose.slides.MathPhantom");
...
exports.Merger = java.import("com.aspose.slides.Merger");
exports.Merger.processToStream = function(arg0, arg1, arg2) {
if (arguments.length == 3 && __typeof__(arg1) == "WriteStream") {
	var outputStreamBuffer = new exports.StreamBuffer();
	exports.Merger.process(arg0, outputStreamBuffer, arg2);
	var buf;
	while ((buf = outputStreamBuffer.read(4096)) != null) {
		arg1.write(new Buffer(buf));
	}
	arg1.end();
}
else if (arguments.length == 2 && __typeof__(arg1) == "WriteStream") {
	var outputStreamBuffer = new exports.StreamBuffer();
	exports.Merger.process(arg0, outputStreamBuffer);
	var buf;
	while ((buf = outputStreamBuffer.read(4096)) != null) {
		arg1.write(new Buffer(buf));
	}
...
exports.OpenAICompatibleWebClient = java.import("com.aspose.slides.OpenAICompatibleWebClient");
exports.OpenAIWebClient = java.import("com.aspose.slides.OpenAIWebClient");
...
exports.PresentationContentAmountType = java.import("com.aspose.slides.PresentationContentAmountType");
...
exports.SensitivityLabel = java.import("com.aspose.slides.SensitivityLabel");
exports.SensitivityLabelAssignmentType = java.import("com.aspose.slides.SensitivityLabelAssignmentType");
exports.SensitivityLabelCollection = java.import("com.aspose.slides.SensitivityLabelCollection");
exports.SensitivityLabelContentType = java.import("com.aspose.slides.SensitivityLabelContentType");
...
exports.ShapeAdjustmentType = java.import("com.aspose.slides.ShapeAdjustmentType");
...
exports.Slide.writeAsEmfToStream = function(slide, arg0) {
if (arguments.length == 2 && __typeof__(arg0) == "WriteStream") {
	var outputStreamBuffer = new exports.StreamBuffer();
	slide.writeAsEmf(outputStreamBuffer);
	var buf;
	while ((buf = outputStreamBuffer.read(4096)) != null) {
		arg0.write(new Buffer(buf));
	}
...
exports.SlideCollection.insertFromHtmlFromStream = function(slidecollection, arg0, arg1, arg2, arg3, arg4, arg5) {
if (arguments.length == 7 && __typeof__(arg1) == "ReadStream" && __typeof__(arg5) == "Function") {
	var inputStreamBuffer = new exports.StreamBuffer();
	arg1.on('data', function(chunk) {
		inputStreamBuffer.write(chunk);
	});
	arg1.on('end', function() {
		...
		var error;
		try {
			item = slidecollection.insertFromHtml(arg0, inputStreamBuffer.toInputStream(), arg2, arg3, arg4);
		}
		catch (err) {
			error = err;
		}
...
else if (arguments.length == 6 && __typeof__(arg1) == "ReadStream" && __typeof__(arg4) == "Function") {
	var inputStreamBuffer = new exports.StreamBuffer();
	arg1.on('data', function(chunk) {
		inputStreamBuffer.write(chunk);
	});
...
else if (arguments.length == 5 && __typeof__(arg1) == "ReadStream" && __typeof__(arg3) == "Function") {
	var inputStreamBuffer = new exports.StreamBuffer();
	arg1.on('data', function(chunk) {
		inputStreamBuffer.write(chunk);
	});
	arg1.on('end', function() {
		...
		var error;
		try {
			item = slidecollection.insertFromHtml(arg0, inputStreamBuffer.toInputStream(), arg2);
		}
		catch (err) {
			error = err;
		}
...
exports.SlidesAIAgent = java.import("com.aspose.slides.SlidesAIAgent");
exports.SlidesAIAgentException = java.import("com.aspose.slides.SlidesAIAgentException");
...
exports.SvgImage.writeAsEmfToStream = function(svgimage, arg0) {
if (arguments.length == 2 && __typeof__(arg0) == "WriteStream") {
	var outputStreamBuffer = new exports.StreamBuffer();
	svgimage.writeAsEmf(outputStreamBuffer);
	var buf;
	while ((buf = outputStreamBuffer.read(4096)) != null) {
		arg0.write(new Buffer(buf));
	}
...
exports.TextSearchOptions = java.import("com.aspose.slides.TextSearchOptions");
...
exports.WorkbookType = java.import("com.aspose.slides.WorkbookType");
